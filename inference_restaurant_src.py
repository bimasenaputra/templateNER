...
def template_entity(words, input_TXT, start):
    ...
    template_list = [" is not a named entity ."," is a Restaurant_Name entity ."," is a Price entity ."," is a Hours entity ."," is a Rating entity ."," is a Location entity ."," is a Dish entity ."," is a Amenity entity ."," is a Cuisine entity ."]
    entity_dict = {0: "O",1: "Restaurant_Name",2: "Price",3: "Hours",4: "Rating",5: "Location",6: "Dish",7: "Amenity",8: "Cuisine"}
...
model = BartForConditionalGeneration.from_pretrained('./exp/mit-restaurant-src')
...
score_list = []
file_path = './mit-restaurant/test.txt'
guid_index = 1
examples = []
...
with open('./pred-res.txt', 'w') as f0:
    f0.writelines(preds_list)
with open('./gold-res.txt', 'w') as f0:
